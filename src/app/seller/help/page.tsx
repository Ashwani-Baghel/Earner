...
export default function SellerHelpCenterPage() {
  ...
  // Filter for SELLER or BOTH
  const sellerFaqs = (faqs?.items || []).filter((faq: any) => faq.target === "SELLER" || faq.target === "BOTH");
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        {sellerFaqs.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-slate-200">
            <p className="text-slate-500">No seller FAQs available at the moment.</p>
          </div>
        )}
      </div>
