...
export default function LegalSettings() {
  ...
  return (
    <SettingsPageTemplate title="Legal Settings" loading={loading} saving={saving} onSave={handleSave}>
      <div className="space-y-6 text-center py-20">
        <h2 className="text-xl font-bold text-slate-800 mb-2">Legal Settings</h2>
