...
export default function BuyerHelpCenterPage() {
  ...
  // Filter for BUYER or BOTH
  const buyerFaqs = (faqs?.items || []).filter((faq: any) => faq.target === "BUYER" || faq.target === "BOTH");
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        {buyerFaqs.length > 0 ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-slate-200">
            <p className="text-slate-500">No buyer FAQs available at the moment.</p>
          </div>
        )}
      </div>
